...
<IconButton iconProps={SettingViewIcon} onClick={openPanel} title="Notification" allowDisabledFocus className="btn-white shadow ml-10" />
    ...
    <Stack className={classNames.cardColumns}>
        <Stack horizontal verticalAlign="center" gap="20" className={classNames.cardHeader}>
            ...
            <span className={classNames.badge}>12</span>
        </Stack>
        <Stack grow tokens={stackTokens} className={classNames.cardBody}>        
            ...
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Property Name" defaultChecked />                
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Property Code" defaultChecked />              
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Fund" defaultChecked />
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Asset ID" defaultChecked />
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Type" defaultChecked />
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
            <Checkbox label="Total NRA (Local)" defaultChecked />
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Total GFA (Local)" defaultChecked />
                <FontIcon aria-label="Compass" iconName="GripperDotsVertical" className={classNames.dragIcon} />
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Year Built" />               
            </Stack> 
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Acquisition Date" />               
            </Stack>
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
                <Checkbox label="Disposition Date" />               
            </Stack> 
            <Stack horizontal verticalAlign="center" horizontalAlign="space-between">
